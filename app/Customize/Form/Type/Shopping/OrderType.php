...
use Customize\Form\Type\Master\DonationPurposeType;
use Customize\Repository\Master\DonationPurposeRepository;
...
class OrderType extends AbstractType
{
    ...
    /**
     * @var DonationPurposeRepository
     */
    protected $donationPurposeRepository;
     ...
     * @param DonationPurposeRepository $donationPurposeRepository
    ...
    public function buildForm(FormBuilderInterface $builder, array $options)
    {
        ...
        $builder->add('offer_memo', TextareaType::class, [
            'required' => false,
            'constraints' => [
            ...
            'mapped' => false,
        ])->add('DonationPurpose', DonationPurposeType::class, [
            'required' => true,
            'constraints' => [
                new Assert\NotBlank(),
            ],
        ])->add('one_stop', CheckboxType::class, [
            'required' => false,
        ])->add('name_announce', CheckboxType::class, [
            'required' => false,
        ])->add('cheer_message_publish', CheckboxType::class, [
            'required' => false,
        ])->add('cheer_message', TextareaType::class, [
            'required' => false,
